    ...
    */
    ...
    struct TTypeInterface : public ITypeInterface
    {
        ...
        virtual void Copy(void* Dest, const void* Src) const override
        {
            ...
            CopyInternal((T*)Dest, (const T*)Src, typename TChooseClass<std::is_trivially_copy_constructible_v<T>, FTrue, FFalse>::Result());
        }
        ...
        virtual bool WriteValue(lua_State* L, void* ValuePtr, int32 IndexInStack, bool bCreateCopy) const override
        {
            ...
            CopyInternal((T*)ValuePtr, &V, typename TChooseClass<std::is_trivially_copy_constructible_v<T>, FTrue, FFalse>::Result());
            return false;
        }
